...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/amyo/Petstore/1.0.0/user")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/amyo/Petstore/1.0.0/user/createWithArray")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/amyo/Petstore/1.0.0/user/createWithList")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/amyo/Petstore/1.0.0/user/{username}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/amyo/Petstore/1.0.0/user/login")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpGet]
        [Route("/amyo/Petstore/1.0.0/user/logout")]
        [ValidateModelState]
